...
import track.ImpressionRepositoryTrait
...
def findById(id: Int): Future[Option[Impression]] = Future.successful(Option(Impression(Option(id),"ABC123","Appnexus",Option(dateTimeEveningWeekEnd))))
